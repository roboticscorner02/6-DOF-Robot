...
"""autogenerated by genpy from robot1_remote/Robot1TaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class Robot1TaskActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "robot1_remote/Robot1TaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot1_remote/Robot1TaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Robot1TaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot1_remote.msg.Robot1TaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot1_remote.msg.Robot1TaskResult()
