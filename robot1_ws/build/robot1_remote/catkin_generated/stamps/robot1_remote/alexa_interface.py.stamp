...
from robot1_remote.msg import Robot1TaskAction, Robot1TaskGoal
import rospy
import threading
import actionlib

threading.Thread(target=lambda: rospy.init_node('alexa_interface', disable_signals=True)).start()
client = actionlib.SimpleActionClient('task_server', Robot1TaskAction)
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        goal = Robot1TaskGoal(task_number=0)
...
class PickIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        goal = Robot1TaskGoal(task_number=1)
        client.send_goal(goal)
...
class SleepIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        goal = Robot1TaskGoal(task_number=2)
        client.send_goal(goal)
...
skill_adapter = SkillAdapter(
    skill=skill_builder.create(), skill_id="aamzn1.ask.skill.769879ab-eb94-48b8-b2db-4c76b6342a65",
    app=app)
